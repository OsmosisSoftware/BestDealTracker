...
public class AmazonItemTest {
  ...
  public void testCreateNewAmazonItem(){
    ...
    AmazonItem amazonItem = new AmazonItem(id, precio, nombre, "http://www.google.com", "BbB8756ABC");
  ...
  @Test
  public void testCreateEmptyAmazonItem(){
    AmazonItem amazonItem = new AmazonItem();

    assertNotNull(amazonItem);
    assertEquals(0, amazonItem.getId());
    assertEquals(0.0, amazonItem.getPrecio(), 0.001);
    assertEquals("", amazonItem.getNombre());
  }

  @Test
  public void testSetIdOnEmptyAmazonItem() {
    AmazonItem amazonItem = new AmazonItem();
    final long id = 1987;
  ...
  public void testSetInvalidUrl(){
    ...
    AmazonItem amazonItem = new AmazonItem(0, 0.0, "foo name", invalidURL, "BbB8756ABC");
  }

  @Test(expected = IllegalArgumentException.class)
  public void testCannotSetIdAgain(){
    AmazonItem amazonItem = new AmazonItem(1, 2.2, "name", "www.google.com", "BbB8756ABC");
    final long invalidId = 2;

    amazonItem.setId(invalidId);
  }
